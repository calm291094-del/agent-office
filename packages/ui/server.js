        ...
        <head>
            ...
            <style>
                * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', sans-serif; }
                ...
                .admin-badge { background: #0d9488; color: white; padding: 2px 12px; border-radius: 20px; font-size: 0.6rem; margin-left: 8px; }
        ...
        <body>
            <div class="office">
                ...
                <div class="footer">
                    ...
                    <span><a href="https://meditech-tienda.onrender.com" style="color:#0d9488;text-decoration:none;">← Volver a MediTech</a></span>
                </div>
            </div>
            ...
            <script>
                ...
                function renderAgentes() {
                    ...
                    container.innerHTML = agents.map(a => {
                        const statusClass = a.status === 'working' ? 'status-working' : 
                ...
                function agregarChat(usuario, mensaje) {
                    ...
                    div.innerHTML = `<span class="${usuario === 'Sistema' ? 'user' : 'agent'}">${usuario}:</span> ${mensaje}`;
                ...
                async function enviarMensaje() {
                    ...
                    // Simular respuesta de un agente
                    setTimeout(() => {
                        const respuestas = [
                        ...
                        const agente = agents.length > 0 ? agents[Math.floor(Math.random() * agents.length)].name : 'Agente';
                        agregarChat(agente, random);
